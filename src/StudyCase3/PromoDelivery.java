 ...
 * @author ASUS
 */
public class PromoDelivery extends Promo {

    public PromoDelivery(String kodePromo, Date tanggalAwal, Date tanggalAkhir, int persenPotongan, double maksPotongan, double minPembelian, String jenisPromo) {
